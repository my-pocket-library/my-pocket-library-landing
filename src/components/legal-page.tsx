...
export function LegalPage({ title, effectiveDate, children }: Props) {
  return (
    <main className="min-h-screen bg-ana-1 text-ink">
      <div className="mx-auto max-w-3xl px-6 pt-10 pb-24 md:px-8 md:pt-14">
        ...
        <header className="mt-10 border-b border-ink/10 pb-8">
        ...
        <div className="mt-10 space-y-8 wrap-anywhere text-[15px] leading-relaxed text-ink/80 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:font-medium [&_h2]:tracking-tight [&_h2]:text-ink [&_h2]:mt-10 [&_h2:first-child]:mt-0 [&_p]:mt-3 [&_p:first-child]:mt-0">
          {children}
        </div>
      </div>
    </main>
